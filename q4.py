...
if __name__ == "__main__":
    ...
    diseases = diseases.set_index('week', drop=True, inplace=True)
    diseases.plot(kind='line', title='Tuberculosis deaths in 1897').get_figure().savefig("output/diseases2.pdf")
    print(diseases)
